...
const TeamMemberCard = ({ member, index }: { member: TeamMember; index: number }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="pointer-events-none absolute inset-0 -z-10 rounded-3xl bg-gradient-to-br from-primary/20 via-transparent to-transparent blur-[90px] opacity-50" />
      ...
      >
        <div className="absolute inset-x-6 top-0 h-40 -translate-y-1/2 rounded-full bg-primary/10 blur-[80px]" />
        <div className="relative space-y-6">
          ...
          <blockquote className="relative rounded-2xl border-l-2 border-primary/50 bg-primary/5 px-6 py-5 text-sm italic text-foreground/90">
            <p>{member.quote}</p>
          </blockquote>
        </div>
